...
@php
  $heroTitle = $heroTitle ?? 'Titre principal de la page';
  $heroDesc = $heroDesc ?? "Petite description d'accroche pour présenter le club, ses valeurs ou son ambiance et ses principales valeurs.";
  $reassuranceTitle = $reassuranceTitle ?? 'Titre de réassurance pour la section';
  $reassuranceDesc = $reassuranceDesc ?? "Un texte rassurant sur l'ambiance, la convivialité, l'encadrement, etc. du club. Ansi que la totalité des activités réalisées par le club tout au long de l'année, nous pouvons savoir quels sont les objectifs du club aussi au niveau compétition et ainsi de suite.";
...
<section class="w-full pb-16">
  <div class="container mx-auto flex flex-col md:flex-row items-center gap-12 px-8">
    <div class="flex-1 flex justify-center mb-8 md:mb-0">
      <img src="/images/club-img.jpg" alt="Ambiance club" class="max-w-xs md:max-w-md rounded-lg shadow-lg object-cover">
    </div>
    <div class="flex-1 flex flex-col items-start justify-center gap-6">
