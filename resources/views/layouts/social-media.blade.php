...
<div class="flex flex-col items-start gap-5">
  <a href="{{ Setting::where('key', 'facebook_link')->first()->value ?? '#facebook' }}" target="_blank"
    rel=" noopener norefere"class="hover:text-wood-light transition flex items-center gap-2 text-white font-body text-base">
    <svg class="w-5 h-5 object-contain" fill="currentColor" viewBox="0 0 24 24">
      <path
  ...
  <a href="{{ Setting::where('key', 'instagram_link')->first()->value ?? '#instagram' }}" target="_blank"
    rel=" noopener norefere"class="hover:text-wood-light transition flex items-center gap-2 text-white font-body text-base">
    <svg class="w-5 h-5 object-contain" fill="currentColor" viewBox="0 0 24 24">
      <path
  ...
  <a href="{{ Setting::where('key', 'twitter_link')->first()->value ?? '#twitter' }}" target="_blank"
    rel=" noopener norefere"class="hover:text-wood-light transition flex items-center gap-2 text-white font-body text-base">
    <svg class="w-5 h-5 object-contain" fill="currentColor" viewBox="0 0 24 24">
      <path
